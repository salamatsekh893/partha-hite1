        ...
        <div className="flex items-start gap-2.5">
          ...
          <div className="space-y-0.5">
            <div className="font-bold flex items-center gap-2">
              <span>Upline Business Count Rules (Real-time Upline Network Accumulation)</span>
            ...
            <p className="text-[11px] text-slate-600 dark:text-slate-300 leading-snug">
              The Business/Registration generated by any ID will automatically accumulate across its entire <strong>Upline Chain</strong> (Direct Sponsor, Grand Sponsor, up to the Root Top ID) for all qualified upline members.
            </p>
          </div>
        </div>
